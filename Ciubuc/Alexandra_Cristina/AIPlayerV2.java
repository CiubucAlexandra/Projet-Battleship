...
public class AIPlayerV2 extends Player{
	
	//private ArrayList<Coordonnes> cAttacks= new ArrayList<Coordonnes>();
	private ArrayList<Coordonnes> save= new ArrayList<Coordonnes>();
	//private ArrayList<Coordonnes> saveAttacks= new ArrayList<Coordonnes>();
	//private ArrayList<Coordonnes> saveAttacksPossibilities= new ArrayList<Coordonnes>();
	
	public AIPlayerV2(String name, String status) {
		super(name,status);
	}
	...
	public void creationFleet() {
		...
		System.out.println("Joueur AIV2 cree sa flotte maintenant ");//adauga nume si aiai si in human
		//coordonatesStart for ship1 Player V0 :
		do {
		...
		}while(s1.positionValidation()!=true || s1.sizeValidation()!=true || c1Start.validationCoordonates()!=true || c1End.validationCoordonates()!=true || this.getF().validationAddShip(s1)!=true);
		...
		}while(s2.positionValidation()!=true || s2.sizeValidation()!=true || c2Start.validationCoordonates()!=true || c2End.validationCoordonates()!=true || this.getF().validationAddShip(s2)!=true);
		...
		}while(s3.positionValidation()!=true || s3.sizeValidation()!=true || c3Start.validationCoordonates()!=true || c3End.validationCoordonates()!=true || this.getF().validationAddShip(s3)!=true);
		...
		}while(s4.positionValidation()!=true || s4.sizeValidation()!=true || c4Start.validationCoordonates()!=true || c4End.validationCoordonates()!=true || this.getF().validationAddShip(s4)!=true);
		...
		}while(s5.positionValidation()!=true || s5.sizeValidation()!=true || c5Start.validationCoordonates()!=true || c5End.validationCoordonates()!=true || this.getF().validationAddShip(s5)!=true);
	...
	public Coordonnes attack() {
		...
		}while(cAttack.validationCoordonates()!=true || save.contains(cAttack));
